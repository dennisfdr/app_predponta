...
/*Carregando Empresas/Setor*/
    ...
    const { data: result, error } = useSWR<AxiosResponse<McaStatusRelatorio[]>>
    ('/mcastatusrelatorio', url => httpClient.get(url) )

    useEffect( () => {
        setListaMcaStatusRelatorio(result?.data || [])
    }, [result])
    ...
    return (
                ...
                <div className="surface-card border-round shadow-2 p-4">
                        ...
                        <div>
                            ...
                            <DataTable ref={dt} value={listaMcaStatusRelatorio} selection={selectedMcaStatusRelatorio} onSelectionChange={(e) => setSelectedMcaStatusRelatorio(e.value)}
