...
interface MedicaoAnaliseOleoFormmProps {
    onSubmit: (medicaoAnaliseOleo: MedicaoAnaliseOleo) => void;
   
}

const formScheme: MedicaoAnaliseOleo = {
...
export const MedicaoAnaliseOleoForm: React.FC<MedicaoAnaliseOleoFormmProps> = ({
    onSubmit,
    ...
    const [selectedMedicaoAnaliseOleo, setSelectedMedicaoAnaliseOleo] = useState<MedicaoAnaliseOleo[]>([]);
    ...
    const formik = useFormik<MedicaoAnaliseOleo>({
        onSubmit,
...
const confirmDelete = (entidade: React.SetStateAction<MedicaoAnaliseOleo>) => {
    ...
    const header = (
        <div className="flex flex-column md:flex-row md:align-items-right justify-content-between">
           <div className="mt-1 md:mt-0 flex justify-content-end">
                <Button icon="pi pi-trash" className="p-button-danger mr-2 p-button-rounded" onClick={confirmDeleteSelected} disabled={!selectedMedicaoAnaliseOleo || !selectedMedicaoAnaliseOleo.length} tooltip="Delete" tooltipOptions={{position: 'bottom'}} />
    ...
    const handleAnaliseOleoChange = (e: { value: any}) => {
        ...
        formik.setFieldValue("analiseOleo", e.value)
    }
                ...
                <div className="surface-card border-round shadow-2 p-4">
                                        ...
                                        <div className="grid">
                                            ...
                                            <div className="col-2">
                                                    ...
                                                    <span className="ml-2">
                                                        ...
                                                        <InputText style={{ width: "100%" }}  disabled placeholder="Código MedicaoAnaliseOleo" id="maoCodigo" name="maoCodigo" value={formik.values.maoCodigo} />
                                           ...
                                           <div className="col-4">
                                                    ...
                                                    <span className="ml-2">
                                                        <label style={{ color: "white" }} htmlFor="maoData">Data*</label><br></br>
                                                        <Calendar  id="maoData" name="maoData" value={date1} onChange={formik.handleChange} dateFormat="dd/mm/yy" mask="99/99/9999" showIcon onBlur={formik.handleBlur}/>
                                
                                                    </span>

                                                    <small className="p-error p-d-block">
                                                        {formik.touched && formik.errors.maoData}
                                                    </small>
                                            </div>
                        ...
                        <div>
                            ...
                            <DataTable ref={dt} value={entidades} selection={selectedMedicaoAnaliseOleo} onSelectionChange={(e) => setSelectedMedicaoAnaliseOleo(e.value)}
                                ...
                                <Column field="maoCodigo" header="Código" sortable style={{ minWidth: '12rem' }}></Column>
                                <Column field="maoData" header="Data" sortable style={{ minWidth: '12rem' }}></Column>
                                <Column field="analiseOleo.anoCodigo" header="Análise Oleo" sortable style={{ minWidth: '10rem' }}></Column>
