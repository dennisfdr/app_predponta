...
@Api(value="API REST ArquivoUpload")
@CrossOrigin(origins = "*")
...
public class ArquivoUploadResources {
	...
	@ApiOperation(value="Busca todos os arquivos da empresa")
	@GetMapping
	...
	@ApiOperation(value="Busca arquivos da empresa por ID")
	...
	@ApiOperation(value="Salva arquivos")
	@PostMapping
	...
	@ApiOperation(value="Atualiza arquivos")
	...
	@ApiOperation(value="Deleta arquivos")
